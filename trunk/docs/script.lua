...
while true do
	...
	Screen.print(80, 300, "En el hay "..maxd.." archivos y carpetas")
	while i <= maxd do
		if System.getType(i) == 0 then
			if i == sel then
				Screen.print(80, y, "->"..System.getName(i))
			else
				Screen.print(80, y, System.getName(i))
			end
		else
			if i == sel then
				Screen.print(80, y, "-><D>"..System.getName(i))
			else
				Screen.print(80, y, "<D>"..System.getName(i))
			end
		end
	...
	if Controls.cross(pad) == 1 then
		...
		if System.getType(sel) == 1 then
			...
			if System.isExt(".PNG", sel) == 1 or System.isExt(".png", sel) == 1 then
				Screen.imageLoadinOne(80, 80, curdir)
				Screen.flip()
				Screen.delay(5)
